...
Res = '/home/dai/tmp/BSD500/Results/Hs';
...
subplot(121);plot(xFinal,arrayBEFinal,'r'),title('BDE'),xlabel('hs'), ylabel('BDE');
subplot(122);plot(xFinal,arrayGCEFinal,'y'),title('GCE'),xlabel('hs'), ylabel('GCE');

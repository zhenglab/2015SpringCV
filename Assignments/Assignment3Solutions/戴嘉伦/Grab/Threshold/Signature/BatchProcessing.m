...
%%Setting
InputImages = '/home/dai/tmp/PASCAL/PASCAL/';
OutputSal = '/home/dai/tmp/PASCAL/PASCAL_Sal/';
%%End Setting



IdsImages = dir(InputImages);       %IdsImages表示InputImages目录下的图片文件，为Ids格式
for threshold=0.2:0.1:0.8
    str=num2str(threshold)          %转换threshold，从数字型变为字符型
    DstOutSal = strcat(OutputSal, str, '/');    %在Sal目录下创建不同阈值输出目录,0.2~0.8

...
int main()
{
	for(int threshold=3;threshold<4;threshold++)
	{
		...
		string path1="D:/研一/assignment3/PASCAL/PASCAL";
		string path2="D:/研一/assignment3/PASCAL/PASCAL_SALENCY_0."+threst;
		string exten="*.jpg";
		string extenout=".jpg";
		string filenames3;
		bool addPath1 = true;
		string output="D:/研一/assignment3/PASCAL/output_4/0."+threst+"/";
		char numch[1];

...
\begin{frame}
\frametitle{\ding{172} Center Prior/Location Prior (\color{yellow} \textbf{Demo})}
...
\begin{frame}
\frametitle{\ding{173} Backgroundness Prior (\color{yellow} \textbf{Demo})}
...
\begin{frame}
\frametitle{\ding{175} Color Prior (\color{yellow} \textbf{Demo})}

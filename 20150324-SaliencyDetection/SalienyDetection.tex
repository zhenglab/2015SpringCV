...
\begin{frame}
\frametitle{{\color{magenta}\ding{172}} Contrast}
\begin{itemize}
\item Color
\item Texture
\end{itemize}
...
\begin{frame}
\frametitle{{\color{magenta}\ding{173}} Regional property descriptor}
\begin{itemize}
...
\begin{frame}
\frametitle{{\color{magenta}\ding{172}} Center Prior/Location Prior (\color{yellow} \textbf{Demo})}
...
\begin{frame}
\frametitle{{\color{magenta}\ding{172}} Center Prior/Location Prior}
...
\begin{frame}
\frametitle{{\color{magenta}\ding{173}} Backgroundness Prior}
...
\begin{frame}
\frametitle{{\color{magenta}\ding{173}} Backgroundness Prior (\color{yellow} \textbf{Demo})}
...
\begin{frame}
\frametitle{{\color{magenta}\ding{174}} Boundary Connectivity Prior}
...
\begin{frame}
\frametitle{{\color{magenta}\ding{175}} Color Prior (\color{yellow} \textbf{Demo})}
...
\begin{frame}
\frametitle{{\color{magenta}\ding{176}} Objectness Prior}
...
\begin{frame}
\frametitle{{\color{magenta}\ding{177}} Smoothness Prior}
...
\begin{frame}
\frametitle{{\color{magenta}\ding{172}} Non-linear\footnote{Peng Jiang et al., ``Salient region detection by ufo: Uniqueness, focusness and objectness'', in ICCV, 2013. }}
...
\begin{frame}
\frametitle{{\color{magenta}\ding{173}} Energy minization\footnote{Wangjiang Zhu and Shuang Liang, ``Saliency Optimization from Robust Background Detection‘’, in CVPR, 2014.}}
...
\begin{frame}
\frametitle{{\color{magenta}\ding{174}} Machine Learning\footnote{Huaizu Jiang et al., ``Salient object detection: a discriminative regional feature integration approach'', in CVPR, 2013.}}
Training examples: 
\begin{itemize}

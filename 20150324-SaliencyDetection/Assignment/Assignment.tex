...
\item[Output] A $m \times n$ matrix. 
\item[Implementation] This step is based on the regional feature you choose in step 3, you have two choices:
\begin{itemize}
\item Color information
\begin{itemize}
\item[-] You should quantify each color channel to have less number of values, then compute a value instead of a vector to represent the color of each pixel. 
\end{itemize}
